...
ConVar physgun_beam_r( "physgun_beam_r", "1.0", FCVAR_ARCHIVE );
ConVar physgun_beam_g( "physgun_beam_g", "1.0", FCVAR_ARCHIVE );
ConVar physgun_beam_b( "physgun_beam_b", "1.0", FCVAR_ARCHIVE );
...
int	C_BeamQuadratic::DrawModel( int )
{
	...
	{
	float r = clamp( physgun_beam_r.GetFloat(), 0.0f, 1.0f );
	float g = clamp( physgun_beam_g.GetFloat(), 0.0f, 1.0f );
	float b = clamp( physgun_beam_b.GetFloat(), 0.0f, 1.0f );
	color.Init( r, g, b );
	}
